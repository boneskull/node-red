...
var auth = require("../../../../runtime/api/auth");
    ...
    describe("enables the editor", function() {
        ...
        before(function() {
            ...
            mockList.forEach(function(m) {
                sinon.stub(require("../../../../runtime/api/editor/"+m),"init",function(){});
            });
            sinon.stub(require("../../../../runtime/api/editor/theme"),"app",function(){ return express()});
        });
        after(function() {
            mockList.forEach(function(m) {
                require("../../../../runtime/api/editor/"+m).init.restore();
            })
            require("../../../../runtime/api/editor/theme").app.restore();
